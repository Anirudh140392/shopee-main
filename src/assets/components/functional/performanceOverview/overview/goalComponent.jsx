...
const GoalComponent = () => {
    ...
    const [goalChartData, setGoalChartData] = useState([
        { id: "Achieved", label: "Achieved", value: 0 },
        { id: "Not Achieved", label: "Not Achieved", value: 0 }
    ]);
                ...
                const updatedChartData = [
                    {
                        id: "Achieved",
                        label: "Achieved",
                        value: data["Achieved goals"] || 0,
                        color:"#495871"
                    },
                    {
                        id: "Not Achieved",
                        label: "Not Achieved",
                        value: data["Unachieved goals"] || 0,
                        color:"#7892BF"
                    }
                ];
                ...
                <div className="px-3 py-2">
                    <div className="row">
                        <div className="col-lg-3">
                            <PieChartComponent data={goalChartData} />
                        </div>
