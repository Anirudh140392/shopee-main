...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const operatorType = queryParams.get("operator") || OPERATOR.FLIPKART;
    setShowSelectedOperator(operatorType);
  }, [location.search]);

  const options = [{ label: "Crompton", value: "Crompton" }];
      ...
      <div className="header-main-con">
        ...
        <div className="d-flex actions-con">
          ...
          <Dropdown className="operator-selected-tab">
            <Dropdown.Toggle disabled variant="white" id="dropdown-basic">
              {"Shopee"}
            </Dropdown.Toggle>
            ...
            <Dropdown.Menu>
              {/* <OperatorList
                                ...
                                selectedOperator={OPERATOR.AMAZON} /> */}
              {/* <OperatorList
                                showSelectedOperator={showSelectedOperator}
                                setShowSelectedOperator={setShowSelectedOperator}
              ...
              {/* <OperatorList
                                showSelectedOperator={showSelectedOperator}
                                setShowSelectedOperator={setShowSelectedOperator}
                                selectedOperator={OPERATOR.MYNTRA} />*/}
              <OperatorList
                showSelectedOperator={showSelectedOperator}
                setShowSelectedOperator={setShowSelectedOperator}
